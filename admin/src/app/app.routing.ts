...
export const appRoutes: Route[] = [
    ...
    { path: 'signed-in-redirect', pathMatch: 'full', redirectTo: 'students' },
    ...
    // Admin routes
    {
        ...
        children: [
            ...
            { path: 'settings/users', loadChildren: () => import('app/modules/admin/users/users.module').then(m => m.UsersModule) },
        ]
    }
];
